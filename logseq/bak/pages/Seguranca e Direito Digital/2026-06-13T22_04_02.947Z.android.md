# Aula 1
	- ## Ponto de Partida
		- We are going to study digital law.
		- Malwares
		- Social Engineering
		- Vulnerability
	- ## Texto de Apoio
		- ![Texto de Apoio](../assets/mack/seguranca e Direito Digital/SEG DIR DIG A1 - Texto de apoio.pdf)
	- ## Praticando
		- Done
	- ## Aplicando Conhecimento
		- https://www.nic.br/sobre/#composicao>
		- https://www.cert.br/certcc/csirts/csirt_faq-br.html
		- Theme: With base on the two links make a infographic shorter than 3 pages that summarize the
		- ### FAQ
			- 1. **O que é um "Computer Security Incident Response Team (CSIRT)"?**
			...
			- 3. **Qual a necessidade de um CSIRT em uma organização?**
			...
			- 4. **Quais tipos de CSIRTs existem?**
				- Os CSIRTs possuem diferentes tamanhos e características e servem a comunidades diversas. Alguns CSIRTs dão suporte a um país inteiro, como por exemplo o [JPCERT/CC](http://www.jpcert.or.jp/english/index.html) (Japan Computer Emergency Response Team Coordination Center). Outros podem prover assistência a uma região em particular, como o [AusCERT](http://www.auscert.org.au/) faz para a região da Ásia e Pacífico. Outros ainda podem prover suporte para uma universidade ou organização comercial em particular. Existem também grupos corporativos que prestam os serviços de um CSIRT para clientes, mediante o pagamento de uma taxa.
			...
			- 5. **Quais são os outros acrônimos para Grupos de Resposta a Incidentes?**
			...
			- 6. **"CERT" pode ser usado no nome de um CSIRT?**
				- "CERT" e "CERT Coordination Center" são registradas no Escritório de Marcas e Patentes (Patent and Trademark Office) dos EUA. Organizações que tenham a intenção de usar o acrônimo "CERT" no nome de seu grupo devem solicitar permissão através de um email para [cert@cert.org](mailto:cert@cert.org). Para informações adicionais a respeito do copyright do CERT/CC, por favor veja nossa seção ["legal information"](http://www.cert.org/legal_stuff/legal_stuff.html). Para informações adicionais sobre o CERT/CC, por favor consulte o documento ["CERT/CC FAQ"](http://www.cert.org/faq/cert_faq.html).
			- 7. **Onde um CSIRT é normalmente encontrado na estrutura organizacional?**
			...
			- 9. **O que é Tratamento de Incidentes?**
			...
			- 11. **Qual o custo da criação de um CSIRT?**
				...
				- Developing an Effective Incident Handling Cost Analysis Mechanism, por David A. Dittrich; SecurityFocus, 12 de junho de 2002
				  [http://online.securityfocus.com/infocus/1592](http://online.securityfocus.com/infocus/1592)
				- Incident Cost and Analysis Model Project
				  [http://www.cic.uiuc.edu/groups/ITSecurityWorkingGroup/archive/Report/ICAMP.shtml](http://www.cic.uiuc.edu/groups/ITSecurityWorkingGroup/archive/Report/ICAMP.shtml)
				- Computer Crime and Security Survey, do Computer Security Institute (CSI) em parceria com o FBI
				  [http://www.gocsi.com/forms/fbi/pdf.jhtml](http://www.gocsi.com/forms/fbi/pdf.jhtml)
				  Information Security Magazine - 2003 Security Survey
				  [http://infosecuritymag.techtarget.com/ss/0,295796,sid6_iss143_art294,00.html](http://infosecuritymag.techtarget.com/ss/0,295796,sid6_iss143_art294,00.html)
				- 2004 Australian Computer Crime and Security Survey
				  [http://www.auscert.org.au/crimesurvey](http://www.auscert.org.au/crimesurvey)
			- 12. **Qual deve ser o tamanho de um CSIRT?**
			...
			- 14. **Que tipo de treinamento é necessário para um CSIRT?**
				...
				- [Cursos da SEI sobre segurança da informação e CSIRTs](http://www.cert.org/training/)
				- [Treinamentos do SANS Institute](http://www.sans.org/) e o [Programa de Certificações GIAC](http://www.giac.org/) (Global Information Assurance Certification)
				- **Nota do Tradutor:** O NBSO/Brazilian CERT é um *Software Engineering Institute Partner* e ministra no Brasil diversos [cursos do CERT®/CC](https://www.cert.br/cursos/).
			- 15. **Onde uma organização pode encontrar mais informações sobre políticas e procedimentos relacionados com CSIRTs?**
				- Questões relacionadas com políticas e procedimentos aplicáveis a CSIRTs estão presentes no ["Handbook for Computer Security Incident Response Teams (CSIRTs)"](http://www.sei.cmu.edu/pub/documents/98.reports/pdf/98hb001.pdf) (Seção 2.2.3)
				...
				- ["Computer Policy & Law Policies List"](http://www.educause.edu/icpl/), compilada pelo pessoal do "Computer Policy and Law Program" da Universidade de Cornell (podem ser feitas buscas por tipos de políticas e por tipos de organizações).
			...
			- 16. **Como uma organização inicia um CSIRT?**
				...
				- [Expectations for Computer Security Incident Response (RFC 2350)](http://www.ietf.org/rfc/rfc2350.txt)
				  [Site Security Handbook (RFC 2196)](http://www.ietf.org/rfc/rfc2196.txt)
					- [Avoiding the Trial-by-Fire Approach to Security Incidents](http://interactive.sei.cmu.edu/Columns/Security_Matters/1999/March/Security.mar99.htm)
				- O CERT/CC também oferece outros [treinamentos](http://www.cert.org/nav/training.html) para aqueles que irão gerenciar um CSIRT, bem como para o pessoal técnico que necessita treinamento na área de análise e resposta a incidentes de segurança em computadores.
				...
				- No AusCERT:
				- [http://www.auscert.org.au/Information/Contact/irt.html](http://www.auscert.org.au/Information/Contact/irt.html)
				- No diretório de CSIRTs europeus:
				- [http://www.ti.terena.nl/teams/](http://www.ti.terena.nl/teams/)
				- **Nota do Tradutor:** O CERT.br mantém uma [lista com diversos CSIRTs brasileiros](https://www.cert.br/csirts/brasil/).
			- 16. **O que é FIRST?**
				...
				- Voce pode conhecer mais sobre o FIRST em sua página web: [http://www.first.org/](http://www.first.org/). Se você desejar tornar-se um membro, por favor consulte a página [http://www.first.org/docs/joining.first.html](http://www.first.org/docs/joining.first.html)
-