- # Log In Screen
  collapsed:: true
	- ## Choose user
		- Choose your Domain Login - Escolha o Domínio de acesso
		- OFI User - Usuário OFI
		- NON Ofi User - Convidado não registrado
		- OR - Ou
	- ## Ofi Login
		- Enter Username - Insira o Nome do Usuário
		- username - Usuário
		- Password - Senha
		- Or select an alternative - Ou selecione uma alternativa
		- OFI Users Login - Login de Usuário Ofi
- # Home Page
  collapsed:: true
	- ## Menu
		- Brazil - Brasil
		- Pricing Management - Gerenciamento de preço
		- Premiums/Commissions -  Premios e Comissões
		- Origin Settings - Configurações de Originação
		- Freight Configuration  - Configurações de Frete
	- ## DashBoard
		- Cocoa - Cacau
		- Trading Product - Produto Comercializado
		- Address - Endereço
		- Select Address - Insira endereço
		- Transaction Period - Período de Transação
			- ### For the Drop downs
				- All Time - Todos
				- Last - Último
				- Month - Mês
		...
		- FIXATION - Fixação
		- FIX - Preço Fixo
		- Transaction Value in BRL - Valor das Transações em Reais
		- Fixed Purchase - Compra Fixa
		- Transaction Value - Valor da Transação
		- Transaction Volume - Volume da transação
		- Top Performers - Maiores Produtores
			- Value - Valor
			- Volume - Volume
			- Count - Quantidade
	- ## Terminal
...
- # Reports
  collapsed:: true
	- ### Header
		- Manage Data Dump - Gerenciamento de Download de Relatório
		- Report Type  - Tipo de relatório
			- Transaction Report - Relatório de Transação
		- Cocoa - Cacau
			- From Date - Data Inicial
			- To Date - Data Final
		- Transaction  - Transação
			- Fixed Purchase - Compra Fixa
			- PTBF Transaction - PTBF
			- Fixation - Fixação
		- Download Dump - Fazer Download
	- Note: Commodity and users should have the same translations use it accordingly
- # Help
  collapsed:: true
	- Device Reset - Resetar Dispositivo
		- User ID: - ID do Usuário
		- (Eg: PCPC) - (Exemplo: PCPC)
		- (Eg: 0000) - (Exemplo: 0000)
		- Role - Papel do Usuário
			- Farmer
			- Micro collector - Micro Coletor
			- Agent - Agente
			- Analytics - Análise
			-
- # Pricing  Management
  collapsed:: true
	- Geo/FL Price Adjustment  - Ajuste de Preço Geografico
		- Select Commodity - Selecione Mercadoria
			- Geography and FL wise Price adjustment settings - Ajuste de Preço por Região Geográfica
			- Coffee - Café
			- Cocoa - Cacau
			- GO - Pesquisar
		- Define geography levels for price adjustments - Defina os níveis geograficos para ajuste de preço.
		- S.NO. - Nº
		- Geo Level - Nível Geografico.
		- Select - Selecionar
...
- # User management
  collapsed:: true
	...
	- Programs/Farmer Group/Section - Programas | Grupo de Produtores | Seção
	- Programs/Farmer Group/Section Sync Errors - Programas | Grupo de Produtores | Errors de SIncronização de Seção
	- ## User Registration
		- Basic details - Informações pessoais
			- Full name - Nome Completo
			- Profile photo - Foto de Perfil
		- Address Details - Informações de endereço
			- ZIP Code - CEP
			- City - Cidade
			- Address - Endereço
		- Bank details - Informações Bancárias
			- Account Number - Número de Conta
			- Bank Passbook Scan Copy - Cópia de Comprovante Bancário
		- Location Details - Informações de Localização
		- Buying Location  - Local de Compra
			- Preferred Delivery Type  - Tipo de entrega
				- Direct delivery - Entrega
				- Withdraw - Retirada | Apanha
			- Preferred Delivery Location  - Preferencia de Local de Entrega
		- Program Details - Informações de Programas
			- Loyalty Program - Programas de Fidelidade
			- Sustainability Program - Programa de Sustentabilidade
		- Farm Details - Informações de Fazenda
			- Zip Code - CEP
			- State - Estado
			- City - Cidade
			- Street Name - Nome da Rua
			- Number - Número
			- Add new farm - Adicione uma Fazenda
			- Remove - Remover
		- Save - Salvar
	- ## Bulk Upload
		- Bulk Upload - Inserção em Massa
	...
	- ## Programs/farmer group/section
		...
		- Move Users within Programs - Movimentar Produtores entre Programs
			...
			- Select - Selecione **all slect placeholders shoul be inserted as "Selecionar"**
			- No results found - Nenhum Resultado foi Encontrado
			- Manage Farmer Group Name and Sections - Gerenciar nome de Grupo de Produtores
	- ## Programs/Farmer Group/ section sync errors
		- Geo Sync Details - Sincronização de Detalhes Geograficos
			- Sync Status - Status de Sincronização
			- Success - Sucesso
			- Failure - Falha
			- No records found - Nenhum Registro foi Encontrado
		- Farmer Registration Sync Details - Sincronização de Detalhes de Registro do Produtor
			- Sync Status - Status de Sincronização
			- Success - Sucesso
			- Failure - Falha
			- No records found - Nenhum Registro foi Encontrado
		- Programs/Farmer Group/Section Sync Details - Programas | Grupo de Produtores | Seção de Sincronização de Detalhes
			- Sync Status - Status de Sincronização
			- Success - Sucesso
			- Failure - Falha
			- No records found - Nenhum Registro foi Encontrado
- # Negotiations
  collapsed:: true
	- ## Transaction creation
		- User type - Tipo de Produtor
		- **all select should be changed to "Selecionar"**
		- ### On search toggle
			- Supplier ID - ID do Fornecedor
			- Supplier Name - Nome Do Fornecedor
			- CPF/CNPJ ID - CPF/CNPJ
	...
	- ## Transaction List
		- Buying Location - Local de Compra
		- CPF/CNPJ ID - CPF/CNPJ
		- PO Number - (Numero da PO) OR (Nº PO)
		- SAP Vendor ID - ID SAP do Fornecedor
		- ### On the users list - TRANSACTION
			- Transaction Status - Status de Transação
			- Purchase Order - Ordem de Compra
			- Buying Location - Localidade de Compra
		- ### On the users list - PENDING APPROVAL
			- Transaction Status - Status de Transação
			- Purchase Order - Ordem de Compra
			- Buying Location - Localidade de Compra
			- Delivery Type - Tipo de Entrega
			- Accepted Price - Preço Aceito
			- Purchase Type - Tipo de Compra
		- ### On the users list - IN NEGOTIATION
			- Transaction Status - Status de Transação
			- Purchase Order - Ordem de Compra
			- Buying Location - Localidade de Compra
			- Delivery Type - Tipo de Entrega
...
- # TCB Online
  collapsed:: true
	- Accepted Price (per Kg) - Preço aceito por Kg
	- Freight Cost - Custo de Frete
	- Buying Location - Local de Compra
	- Farm State - Estado Fazenda
	- Farm City - Cidade da Fazenda
	- Sustainability Program - Programa de Sustentabilidade
	- Loyalty Program - Programa de Fidelidade
	- * Input Fields are mandatory - *Campos Obrigatório
- # Premiums and Comissions
  collapsed:: true
	- ## Farmer Premiums - Prêmios do Produtor
		- Select Commodity - Selecione Comodity
		- Select Program type - Selecione o Tipo de Programa
		- Go - Pesquisar
		- Susteinability Program - Programe de Sustentabilidade
		- Loyalty Program - Programa de Fidelidade
		- ### On the table - SUSTEINABILITY
			- Sustainability Program Premium - Prêmio de Programa de Sustentabilidade
			- Action - Ação
		- ### On the table - LOYALTY
			- Loyalty Program - Prêmio de Programa de Fidelidade
			- Premium - Prêmio
			- Action - Ação
	- ## Premium Process - Processo de Prêmio
		- FL Commission Processing - Processamento de Comissão do Intermediário
		- Select Commodity  - Selecione Commodity
		- Select Commission Type  - Selecione o Tipo de Comissão
		- Select Trading Product - Selecione a Qualidade do Produto
		- Farmer Lead ID - ID do Produtor Intermediário
		- Advance Search - Pesquisa Avançada
			- phone Number - Número de Celular
			- Search - Pesquisar
		- Search - Pesquisar
	- ## Premium Process Errors - Erro de Processo de Prêmio
		- Select Commodity  - Selecione commodity
			- Cocoa - Cacau
		- Premium Name  - selecione Prêmio
	- ## Periodic Premium Approval - Aprovação de Prêmio Periódico
		- Select Commodity  - Selecione Commodity
		- Farmer ID - ID do Produtor
		- Trading Product - Qualidade do Produto
		- Premium name - Nome do Prêmio
		- Status
...
- # Origin Settigns
  collapsed:: true
	- ## Price Settings
		- ### Price configuration
			- Select Commodity - Selecione Commodity
			- Publish Time and Expiry logic - Hora de publicação e Lógica da Validade
			- Publish Time-Zone - Fuso Horário da Publicação
			- Multiple Publish before expiry time - Multiplas Publicações Antes de Expirar
			- Recurring Price publish logic - Logica da Publicação de Preço Recorrente
			- Enter recurring period (Days) - Insira o Período em Dias
			- DropOff Start and Expiry time logic - Inserção de Hora de Início e Expiração
			- Olam Direct System TCB - Sistema Olam Direct TCB
			- Farmer Level Pricing - Nível do Preço Produtor
			- Offer Validity Settings - Configuração de Validade de Oferta
	...
	- ## Manage Features
		...
		- ### Feature Settings
			...
			- | **English**| **Portuguese**               |
			  ...
			  | Farmer Payments Transactions (Admin)| Transações de Pagamentos de Agricultores (Admin) |
