...
- # Dopamine tolerance
	- It affects the amount of receptors available instead of the actual dopamine liberation, so any other task will need to be super stimulating for it to make a dent in the
- # Screens
